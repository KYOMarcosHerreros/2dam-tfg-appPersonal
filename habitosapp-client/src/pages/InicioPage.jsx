...
export default function InicioPage() {
  ...
  const cargarDatos = async () => {
    try {
      ...
      // Mostrar confeti si todos los hábitos están completados
      if (nuevasEstadisticas.habitosCompletados === nuevasEstadisticas.habitosHoy && nuevasEstadisticas.habitosHoy > 0) {
  ...
  return (
    <div className="inicio-contenedor">
      {/* Confeti cuando se completan todos los hábitos */}
      <ConfettiCelebration trigger={mostrarConfeti} />
            ...
            {!estadisticas?.tieneHabitos ? (
              ...
              <div className="widget-contenido">
                ...
                <div className="widget-stats">
                  <span><AnimatedNumber value={estadisticas.habitosCompletados} duration={800} />/{estadisticas.habitosHoy} hoy</span>
          ...
          >
            <div className="widget-contenido">
              ...
              <div className="widget-numero-grande">
                <AnimatedNumber value={estadisticas?.recordUso || 0} duration={1000} />
              </div>
            ...
            <div className="widget-contenido">
              ...
              <div className="widget-stats-grid">
                <div className="stat-item">
                  <span className="stat-numero"><AnimatedNumber value={estadisticas?.habitosEstaSemana || 0} duration={1000} /></span>
                  <span className="stat-label">Completados</span>
                </div>
                <div className="stat-item">
                  <span className="stat-numero"><AnimatedNumber value={estadisticas?.totalHabitos || 0} duration={1000} /></span>
